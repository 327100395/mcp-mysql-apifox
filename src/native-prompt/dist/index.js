...
var platform_check_1 = __importDefault(require("./lib/platform-check"));
var platforms_1 = require("./lib/platforms");
var platform = platform_check_1.default();
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case 'linux': return [3, 5];
                        case 'darwin': return [3, 7];
                    }
                    return [3, 9];
                case 1:
